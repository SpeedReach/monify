...
func RegisterGroupsBillServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server GroupsBillServiceServer) error {
	...
	mux.Handle("PUT", pattern_GroupsBillService_ModifyBill_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/.GroupsBillService/ModifyBill", runtime.WithHTTPPathPattern("/v1/groups_bill"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterGroupsBillServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client GroupsBillServiceClient) error {
	...
	mux.Handle("PUT", pattern_GroupsBillService_ModifyBill_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/.GroupsBillService/ModifyBill", runtime.WithHTTPPathPattern("/v1/groups_bill"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	...
	pattern_GroupsBillService_ModifyBill_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "groups_bill"}, ""))
